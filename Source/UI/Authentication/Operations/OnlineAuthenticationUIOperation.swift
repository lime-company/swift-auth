...
public class OnlineAuthenticationUIOperation: AuthenticationUIOperation {
    ...
    public init(isSerialized: Bool, execution: @escaping (LimeAuthSession, PowerAuthAuthentication, @escaping ExecutionCallback) -> Operation?) {
