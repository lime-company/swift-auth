...
class EnterFixedPasscodeViewController: LimeAuthUIBaseViewController, EnterPasswordRoutableController, PinKeyboardViewDelegate {
    ...
    private func executeOperation(biometry: Bool, delay: Bool = true) {
        ...
        if biometry {
            ...
            authentication.biometryPrompt = uiRequest.prompts.biometricPrompt ?? nil
        } else {
