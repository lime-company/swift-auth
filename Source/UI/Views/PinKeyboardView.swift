...
open class PinKeyboardView : UIView {
    ...
    public func setSpecialKeyVisible(_ specialKey: PinKeyboardSpecialKey, visible: Bool) {
        if specialKey == .biometry {
            ...
            if visible {
                keyForSharedBackspaceAndCancel = specialKey
            } else {
                keyForSharedBackspaceAndCancel = specialKey == .cancel ? .backspace : .cancel
            }
    ...
    public func isSpecialKeyVisible(_ specialKey: PinKeyboardSpecialKey) -> Bool {
        if specialKey == .biometry {
            ...
            if backspaceButton != nil {
                return keyForSharedBackspaceAndCancel == specialKey
            }
        } else {
    ...
    private var keyForSharedBackspaceAndCancel: PinKeyboardSpecialKey = .cancel
