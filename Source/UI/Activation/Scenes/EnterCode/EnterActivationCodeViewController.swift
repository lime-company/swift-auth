...
public class EnterActivationCodeViewController: UIViewController, ActivationProcessController {
    ...
    open func prepareUI() {
        //let uiData = router.activationProcess.uiDataForEnterActivationCode
    }
}
